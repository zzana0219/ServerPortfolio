...
CPacket& CPacket::operator=(CPacket& clSrcPacket) 
{
    ...
    //memcpy(m_chpBuffer, clSrcPacket.m_chpBuffer, clSrcPacket.m_iDataSize);
    // memcpy 대신 직접 할당
...
CPacket& CPacket::operator<<(unsigned char byValue) 
{
    ...
    //memcpy(m_chpBuffer + m_iWritePos, &byValue, sizeof(unsigned char));
...
CPacket& CPacket::operator<<(char chValue) 
{
    ...
    //memcpy(m_chpBuffer + m_iWritePos, &chValue, sizeof(char));
...
CPacket& CPacket::operator<<(short shValue)
{
    ...
    //memcpy(m_chpBuffer + m_iWritePos, &shValue, sizeof(short));
...
CPacket& CPacket::operator<<(unsigned short wValue)
{
    ...
    //memcpy(m_chpBuffer + m_iWritePos, &wValue, sizeof(unsigned short));
...
CPacket& CPacket::operator<<(int iValue) 
{
    ...
    //memcpy(m_chpBuffer + m_iWritePos, &iValue, sizeof(int));
...
CPacket& CPacket::operator<<(long lValue)
{
    ...
    //memcpy(m_chpBuffer + m_iWritePos, &lValue, sizeof(long));
...
CPacket& CPacket::operator<<(unsigned long dwValue)
{
    ...
    //memcpy(m_chpBuffer + m_iWritePos, &dwValue, sizeof(unsigned long));
...
CPacket& CPacket::operator<<(float fValue) 
{
    ...
    // memcpy 대신 직접 할당
    //memcpy(m_chpBuffer + m_iWritePos, &fValue, sizeof(float));
...
CPacket& CPacket::operator<<(__int64 iValue)
{
    ...
    //memcpy(m_chpBuffer + m_iWritePos, &iValue, sizeof(__int64));
...
CPacket& CPacket::operator<<(double dValue)
{
    ...
    //memcpy(m_chpBuffer + m_iWritePos, &dValue, sizeof(double));
...
CPacket& CPacket::operator>>(unsigned char& byValue) 
{
    ...
    //memcpy(&byValue, m_chpBuffer + m_iReadPos, sizeof(unsigned char));
...
CPacket& CPacket::operator>>(char& chValue)
{
    ...
    //memcpy(&chValue, m_chpBuffer + m_iReadPos, sizeof(char));
...
CPacket& CPacket::operator>>(short& shValue)
{
    ...
    //memcpy(&shValue, m_chpBuffer + m_iReadPos, sizeof(short));
...
CPacket& CPacket::operator>>(unsigned short& wValue)
{
    ...
    //memcpy(&wValue, m_chpBuffer + m_iReadPos, sizeof(unsigned short));
...
CPacket& CPacket::operator>>(int& iValue)
{
    ...
    //memcpy(&iValue, m_chpBuffer + m_iReadPos, sizeof(int));
...
CPacket& CPacket::operator>>(long& lValue)
{
    ...
    //memcpy(&lValue, m_chpBuffer + m_iReadPos, sizeof(long));
...
CPacket& CPacket::operator>>(unsigned long& dwValue)
{
    ...
    //memcpy(&dwValue, m_chpBuffer + m_iReadPos, sizeof(unsigned long));
...
CPacket& CPacket::operator>>(float& fValue)
{
    ...
    //memcpy(&fValue, m_chpBuffer + m_iReadPos, sizeof(float));
...
CPacket& CPacket::operator>>(__int64& iValue)
{
    ...
    //memcpy(&iValue, m_chpBuffer + m_iReadPos, sizeof(__int64));
...
CPacket& CPacket::operator>>(double& dValue) 
{
    ...
    //memcpy(&dValue, m_chpBuffer + m_iReadPos, sizeof(double));
